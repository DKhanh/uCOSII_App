...
*/
// Add your code here!!
        InterruptSem = OSSemCreate(N_INTERRUPTS);
// End of your code!!
...
{
    INT8U  i;
    INT8U number_normal_task = N_TASKS - N_INTERRUPTS;
    INT8U number_interrupt_task = N_INTERRUPTS;
...
*/
// Add your code here!!
    for(i = 0; i < number_normal_task; i++)
    {
        TaskData[i] = i + '0';
        OSTaskCreate(Task, (void *)(&TaskData[i]), &TaskStk[N_TASKS - i - 1][TASK_STK_SIZE - 1], i + 1);
    }

    for(i = number_normal_task; i < N_TASKS; i++)
    {
        TaskData[i] = i + '0';
        OSTaskCreate(TaskInterrupt, (void *)(&TaskData[i]), &TaskStk[N_TASKS - i - 1][TASK_STK_SIZE - 1], i + 1);
    }
